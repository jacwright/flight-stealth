...
package flight.display
{
	...
	/**
	 * Advanced Sprite implementation providing styling, transformation and
	 * simple layout properties, also making the display bindable.
	 */
	public class SpriteDisplay extends Sprite implements IStyleable, ITransform, ILayoutBounds, IInvalidating, IMXMLObject
	{
...
//			}
		...
		public function set maxWidth(value:Number):void
		{
			...
			if (_contained && value > _measured.maxWidth) {
		...
		public function set maxHeight(value:Number):void
		{
			...
			if (_contained && value > _measured.maxHeight) {
		...
		{
			if (_contained != value) {
				DataChange.queue(this, "contained", _contained, _contained = value);
